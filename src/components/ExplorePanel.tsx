      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        <AnimatePresence mode="wait">
          {!activeContent ? (
            ...
            /* Rendered content placeholder — this is where AI-driven sections will appear */
            <motion.div
              key="content"
            ...
            >
              ...
              {/* Visual content section — placeholder for now */}
              <div className="rounded-2xl border border-border/30 bg-secondary/20 p-6">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{activeContent}</p>
                  </div>
                </div>

                <div className="space-y-3 mt-6">
                  {/* Simulated rendered content blocks */}
                  {[1, 2, 3].map((i) => (
                    <motion.div
                      key={i}
                      ...
                      className="h-16 rounded-xl bg-secondary/40 border border-border/20 animate-pulse"
                    />
                  ))}
                  <p className="text-xs text-muted-foreground/50 text-center pt-2">
                    Visual content sections will render here
                  </p>
                </div>
              </div>
            </motion.div>
